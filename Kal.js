...
function renderKaleidoscope() {
    ...
    context.save();
    context.translate(w/2-hyp+i, h/2-adj);
    ...
    context.globalAlpha = 0.5;
      for (let i = 0; i < 24; i++) {
        ...
        context.drawImage(hexagonCanvas, 4*adj*Math.sin(i*Math.PI/6), 4*adj*Math.cos(i*Math.PI/6));
        context.drawImage(hexagonCanvas, 6*adj*Math.sin(i*Math.PI/9), 6*adj*Math.cos(i*Math.PI/9));
    }
        context.restore();
